    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Putra Esa Nanda");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Putra Esa Nanda");
                mPerson.setAge(17);
                mPerson.setEmail("putresnn@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "08997198970";
